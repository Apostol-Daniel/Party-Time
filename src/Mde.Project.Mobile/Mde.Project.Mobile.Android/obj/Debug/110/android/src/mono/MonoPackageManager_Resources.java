...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Mde.Project.Mobile.Android.dll" comes first in this list. */
		"Mde.Project.Mobile.Android.dll",
		"ExoPlayer.Core.dll",
		"ExoPlayer.Dash.dll",
		"ExoPlayer.dll",
		...
		"System.Reactive.dll",
		"Udara.Plugin.XFColorPickerControl.dll",
